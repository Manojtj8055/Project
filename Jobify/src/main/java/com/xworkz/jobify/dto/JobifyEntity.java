...
public String toString() {
	return "JobifyEntity [id=" + id + ", name=" + name + ", email=" + email + ", password=" + password
			...
			+ updatedBy + ", updatedOn=" + updatedOn + ", status=" + status + ", loginAttempts=" + loginAttempts
...
public JobifyEntity(int id, String name, String email, String password, String confirmPassword, String phoneNumber,
		AccountType job, String createdBy, LocalDate createdOn, String updatedBy, LocalDate updatedOn,String accountType,String status,int loginAttempts,String loginStatus,String resetOtp,String gender) {
	super();
	this.id = id;
	this.name = name;
	this.email = email;
