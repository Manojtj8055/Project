...
.signup-form, .signin-form, .signin-image {
  width: 30%;
  overflow: hidden; }
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-image">
                        <img src="images/Job1.jpeg" style="border-radius: 20%; width: 100%;" alt="sing up image">
                       
                    </div>
                    <div style=" margin-left: 40px;   border-left: 1px dotted #5f656d; /* Border on the left */
                    width: 1px; /* Width instead of height */ "></div>
                    <div class="signup-form">
                        ...
                        <form action="save" method="POST" class="register-form" id="register-form">
                            ...
                            <p style="color: red;">${notReading }</p>
                            <div class="form-group">
                                <label for="email"><i class="zmdi zmdi-email"></i></label>
                                <input type="email" name="email" id="email" placeholder="Your Email"/>
                            </div>
                            <p style="color: red;">${notChecking}</p> 
                            <p style="color: red;">${emailFound}</p>
                                                    
                            <div class="form-group">
                                <label for="Mobile"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="tel" name="phoneNumber" id="mobile" placeholder="Mobile Number"/>
                            </div>
                            <p style="color: red;">${numberMissmatch}</p>
                            
                            <div class="form-group">
                                <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="password" id="pass" placeholder="Password"/>
                            </div>
                            <p style="color: red;">${ passwordMissMatch}</p>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="accountType" id="inlineRadio1" value="JobSeeker" checked>Job Seeker
                              </div>
                              
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="accountType" id="inlineRadio2" value="JobProvider">Job Provider
                              </div>
                              </div>
                              <div class="form-group">
                            <div class="form-check form-check-inline">
                            ...
                            <div class="form-group form-button" >
                                <input type="submit" style="background-color: #6f5596" name="signup" id="signup" class="form-submit" value="Register"/>
                           		 ...
                           		 <a href="SignIn.jsp" class="form-submit" style="background-color: #6f5596">Sign In</a>
